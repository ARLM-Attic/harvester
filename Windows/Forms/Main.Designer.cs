namespace Harvester.Forms
{
  partial class Main
  {
    ...
    private void InitializeComponent()
    {
      ...
      this._clearHistoryButton.ToolTipText = "Clear History (Ctrl+Shift+C)";
      // 
      // _colorPickerButton
      // 
      ...
      this._colorPickerButton.ToolTipText = "Color Picker (Ctrl+Shift+P)";
      // 
      // _scrollResumeButton
      // 
      ...
      this._scrollResumeButton.ToolTipText = "Resume Auto-Scroll (Ctrl+Shift+V)";
      // 
      // _separator2
      // 
      ...
      this._filterLevelButton.ToolTipText = "Filter by Level (Ctrl+Alt+L)";
      // 
      ...
      this._filterProcessButton.ToolTipText = "Filter by Processes (Ctrl+Alt+P)";
      // 
      ...
      this._filterApplicationButton.ToolTipText = "Filter by Applications (Ctrl+Alt+A)";
      // 
      // _filterSourceButton
      // 
      ...
      this._filterSourceButton.ToolTipText = "Filter by Sources (Ctrl+Alt+S)";
      // 
      // _filterUserButton
      // 
      ...
      this._filterUserButton.ToolTipText = "Filter by Users (Ctrl+Alt+U)";
      // 
      ...
      this._filterMessageButton.ToolTipText = "Filter by Messages (Ctrl+Alt+M)";
      // 
      // _separator3
      // 
